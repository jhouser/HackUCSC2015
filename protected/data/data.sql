...
-- 7:30 - 9:00 pm
('Craft Beer Tasting', 'Enjoy some local brews', 2, 1421177400, 1421182800)
-- Wednesday
-- 6:00 - 7:00am
('Early Bird Bagle Deal', '20% off for early risers at Bobs Bagels', 2, 1421215200, 1421218800) 
-- 11 - 1:45
('Read to Children', 'Come read books to preschoolers at the library', 4, 1421233200, 1421243100)
-- 12 - 3pm
('Sale on Bananas', 'A-PEEL-ING Fruit store', 2, 1421236800, 1421247600)
-- 2 - 7pm
('Art and Wine Festival', 'Booze and peruse on main street', 2, 1421244000, 1421262000)  
